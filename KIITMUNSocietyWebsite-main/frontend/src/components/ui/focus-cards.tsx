    ...
    >
      ...
      {showControls && totalSlides > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm transition-all duration-200 opacity-70 hover:opacity-100 rounded-full p-3 text-white hover:text-gray-200 shadow-lg"
          ...
          <button
            onClick={goToNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm transition-all duration-200 opacity-70 hover:opacity-100 rounded-full p-3 text-white hover:text-gray-200 shadow-lg"
      ...
      {autoPlay && totalSlides > 1 && (
        <button
          ...
          className="absolute top-4 right-4 bg-white/20 hover:bg-white/30 backdrop-blur-sm transition-all duration-200 opacity-70 hover:opacity-100 rounded-full p-2 text-white hover:text-gray-200 shadow-lg"
